...
def algoritmo_file():
    ...
    st.title(f'Quiz Algoritmo!')

    # Configurar a chave de API da OpenAI (garanta que a chave não esteja hardcoded no código)
    ...
    def gerar_pergunta():
        pergunta = ("Crie uma pergunta sobre Algoritmos com 4 alternativas, identificando qual é a correta. Formato: "
